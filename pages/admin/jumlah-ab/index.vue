        ...
        <div class="flex items-center justify-between">
          <div class="relative">
            <h1 class="text-5xl font-black text-blue-600 mb-3">
              🚀 Data Jenjang Analis Bangkom
            </h1>
            <p class="text-gray-700 text-xl font-medium">Kelola data Analis Bangkom</p>
          ...
          <div class="hidden md:flex items-center gap-6">
            <div class="text-right">
              ...
              <div class="text-sm text-gray-600 font-medium">Total Pegawai Analis Bangkom</div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-8 mb-8">
      <div class="bg-white rounded-xl p-6 shadow-sm border border-gray-200">
        <h3 class="font-black text-xl text-blue-600 mb-4">
          📊 Distribusi Analis Bangkom per Jenjang
        </h3>
        <client-only>
      ...
      <div class="bg-white rounded-xl p-6 shadow-sm border border-gray-200">
        <h3 class="font-black text-xl text-blue-600 mb-4">
          📊 Proporsi Jenjang Analis Bangkom
        </h3>
        <client-only>
...
onMounted(async () => {
  ...
  const res = await fetch("/api/analis_bangkom")
...
async function handleAddData() {
  ...
  try {
    ...
    // Refresh data
    const r = await fetch("/api/analis_bangkom")
